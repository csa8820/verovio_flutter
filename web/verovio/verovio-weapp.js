;(function(g){
  g.__VRV_WASM_ENGINE = (typeof WXWebAssembly !== 'undefined') ? WXWebAssembly : g.WebAssembly;
  g.__VRV_WASM_PATH = (typeof wx !== 'undefined' && wx.__verovioWasmPath) ? wx.__verovioWasmPath : '/verovio/verovio.wasm.br';
  if (!g.crypto || typeof g.crypto.getRandomValues !== 'function') {
    g.crypto = g.crypto || {};
    g.crypto.getRandomValues = function(arr){ for (var i=0;i<arr.length;i++) arr[i] = (Math.random()*256)|0; return arr; };
  }
  g.__VRV_NODE_CRYPTO = {
    randomFillSync: function(arr) {
  ...
  if (typeof g.TextDecoder === 'undefined') {
    g.TextDecoder = function(){ this.decode = function(buf){ var b = buf instanceof ArrayBuffer ? new Uint8Array(buf) : new Uint8Array(buf.buffer||buf); var s=''; for (var i=0;i<b.length;i++) s+=String.fromCharCode(b[i]); try { return decodeURIComponent(escape(s)); } catch(e){ return s; } }; };
  }
  if (typeof g.TextEncoder === 'undefined') {
    g.TextEncoder = function(){ this.encode = function(str){ str=unescape(encodeURIComponent(str)); var a=new Uint8Array(str.length); for (var i=0;i<str.length;i++) a[i]=str.charCodeAt(i); return a; }; };
  }
})(typeof globalThis!=='undefined'?globalThis:this);
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(null, globalThis.__VRV_NODE_CRYPTO) :
	typeof define === 'function' && define.amd ? define(['node:fs', 'node:crypto'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.verovio = factory(global.require$$0, global.require$$1));
